...
export default function Footer({ className }: { className?: string }) {
  ...
  return (
    <div
      className={
        className ||
        'relative flex items-center justify-center gap-2 px-2 py-2 text-center text-xs text-gray-600 dark:text-gray-300 md:px-[60px] mb-2' // Added margin-bottom here for spacing
      }
    >
